...
export default function Error401() {
  ...
  return (
    ...
    //   </div>
    // </div>
    <div className="h-100 d-flex text-center mx-auto justify-content-center text-align-center align-items-center flex-column bg-white">
      <img
        // style={{ height: "5vh", marginRight: "10px" }}
        src="/global/images/error401.gif"
        alt="error401-Not Allowed"
      ></img>
      <button onClick={() => navigate(-1)}>Go back</button>
      {/* <Link className="text-danger font-weight-heavy" to="/">
        Login Now
      </Link> */}
    </div>
  );
